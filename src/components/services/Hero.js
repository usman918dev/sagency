...
const Hero = ({ title, coverImage, icon: iconName, badge }) => {
    ...
    return (
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center text-center text-white px-6">
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#080b12] via-[#080b12]/80 to-[#080b12]/60 pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
                {badge && (
                    <motion.div
                        className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-[var(--background-alt)] border border-[var(--border)] text-[#9D26FF] text-xs font-bold uppercase tracking-widest mb-4 shadow-md"
                ...
                <motion.h1
                    className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight drop-shadow-lg"
                    variants={sentence}
                    initial="hidden"
                    animate="visible"
                >
